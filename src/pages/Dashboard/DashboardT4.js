...
import headerImage from "../../image/bg4.jpg";
    ...
    <div>
      ...
      >
        ...
        <div
          ...
          style={{
            position: "absolute", // overlay on hero-section
            top: "350px", // adjust freely (move up/down)
            left: "50%",
            transform: "translateX(-50%)", // center horizontally
            zIndex: 3,
            paddingLeft: "100px",
            paddingRight: "100px",
            maxWidth: "1200px", // keep it contained
          }}
        >
          <h4
            className="text-white fw-bold text-center mb-4"
            style={{ fontSize: "32px", fontFamily: "Poppins", fontWeight: 600 }}
          >
            Find Your Ideal Home Faster Than Ever
          </h4>
