...
const ListingCardSkeleton = lazy(() => import("../../components/LoadingSkeleton"));
...
const SearchPage = () => {
  ...
  const [selectedLocation, setSelectedLocation] = useState(state?.selectedLocationId || "");
  ...
  const [searchedLocationName, setSearchedLocationName] = useState(state?.selectedLocationName || "");
  ...
  const handleViewDetails = useCallback(
    (productId, title, location) => {
      ...
      navigate(`/property/${titleSlug}`, { state: { productId, title, location } });
    },
    [navigate]
  );
  ...
  const memoizedListings = useMemo(() => {
    ...
    return paginatedProducts.map((product) => {
      if (template === "template1" || template === "template2") {
        return <ListingCard key={product.id_listing} product={product} years={years} handleViewDetails={handleViewDetails} activeYear={activeYear} />;
      }
      if (template === "template3") {
        return <ListingCard3 key={product.id_listing} product={product} years={years} handleViewDetails={handleViewDetails} activeYear={activeYear} />;
      }
      if (template === "template4") {
        return <ListingCard4 key={product.id_listing} product={product} years={years} handleViewDetails={handleViewDetails} activeYear={activeYear} />;
      }
      return null;
    });
  }, [loading, products, years, handleViewDetails, activeYear, currentPage, template]);
      ...
      <div className="container py-3">
        ...
        <div className="sticky-top bg-light py-2 z-index-3">
          <Suspense fallback={<div>Loading filters...</div>}>
            {template === "template1" && <SearchFilter {...{ locations, years, selectedLocation, selectedYear, searchTerm, setSelectedLocation, setSelectedYear, setSearchTerm, handleSearch, activeTab, setActiveTab, selectedCategory, setSelectedCategory, selectedHolding, setSelectedHolding, priceRangeDisplay, setPriceRangeDisplay, bedroomDisplay, setBedroomDisplay, bathroomDisplay, setBathroomDisplay, priceRange, setPriceRange, bathroomRange, setBathroomRange, roomRange, setRoomRange, selectedAreaIds, setSelectedAreaIds }} />}
            {template === "template2" && <FilterT2 {...{ locations, agent, years, selectedLocation, selectedYear, searchTerm, setSelectedLocation, setSelectedYear, setSearchTerm, handleSearch, activeTab, setActiveTab, selectedCategory, setSelectedCategory, selectedHolding, setSelectedHolding, priceRangeDisplay, setPriceRangeDisplay, bedroomDisplay, setBedroomDisplay, bathroomDisplay, setBathroomDisplay, priceRange, setPriceRange, bathroomRange, setBathroomRange, roomRange, setRoomRange, selectedAreaIds, setSelectedAreaIds }} />}
            {template === "template3" && <FilterT3 {...{ locations, years, selectedLocation, selectedYear, searchTerm, setSelectedLocation, setSelectedYear, setSearchTerm, handleSearch, activeTab, setActiveTab, selectedCategory, setSelectedCategory, selectedHolding, setSelectedHolding, priceRangeDisplay, setPriceRangeDisplay, bedroomDisplay, setBedroomDisplay, bathroomDisplay, setBathroomDisplay, priceRange, setPriceRange, bathroomRange, setBathroomRange, roomRange, setRoomRange, selectedAreaIds, setSelectedAreaIds }} />}
            {template === "template4" && <FilterT4 {...{ locations, agent, years, selectedLocation, selectedYear, searchTerm, setSelectedLocation, setSelectedYear, setSearchTerm, handleSearch, activeTab, setActiveTab, selectedCategory, setSelectedCategory, selectedHolding, setSelectedHolding, priceRangeDisplay, setPriceRangeDisplay, bedroomDisplay, setBedroomDisplay, bathroomDisplay, setBathroomDisplay, priceRange, setPriceRange, bathroomRange, setBathroomRange, roomRange, setRoomRange, selectedAreaIds, setSelectedAreaIds }} />}
          </Suspense>
        </div>
        ...
        <div className="row mt-4">
          ...
          <div className="col-lg-3 col-md-4">
            <Suspense fallback={<div>Loading sidebar...</div>}>
              <SidebarFilters selectedLocationName={searchedLocationName} searchType={searchType} />
            </Suspense>
          </div>
        </div>
