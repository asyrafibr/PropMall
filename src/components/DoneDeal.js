  ...
  useEffect(() => {
    const fetchFilterData = async () => {
      try {
        ...
        // Initialize indexes for each card
      ...
      <div className="container-fluid" style={{ padding: "0 50px" }}>
        <div className="row mx-0">
          {doneDeal.map((card) => {
            ...
            const animation = animState[card.id_listing] || {
              phase: "idle",
              direction: null,
              nextIndex: null,
            };
                    ...
                    {card.photos?.length > 1 && (
                      <>
                        <button
                          ...
                          onClick={() =>
                            handlePrev(card.id_listing, card.photos.length)
                          }
                        ...
                        <button
                          ...
                          onClick={() =>
                            handleNext(card.id_listing, card.photos.length)
                          }
